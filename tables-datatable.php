	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
						<a href="dashboard.php"><i class="fa fa-fw fa-bars"></i><span> Ana Sayfa </span> </a>
                    </li>
					...
					<li class="submenu">
                        <a href="#" class="active"><i class="fa fa-fw fa-table"></i> <span> Tablolar </span> <span class="menu-arrow"></span></a>
							<ul class="list-unstyled">
								...
								<li class="active"><a href="tables-datatable.php">Data Tables</a></li>
							</ul>
                    </li>
...
for ($kayit=1;$kayit<12;$kayit++) 
{
echo $kayit; 
echo " "; 
}

					$kayit=mysqli_query($baglan,"SELECT yangin.kayit_no FROM yangin ORDER BY kayit_no ASC");
		if($kayit)
	{
        $no=mysqli_fetch_array($kayit);    
        echo $no["0"];
	}
	?>
											...
											<tr>
												<td>
												<?php
					$kayit1=mysqli_query($baglan,"SELECT yangin.kayit_no FROM yangin ORDER BY kayit_no ASC");
		if($kayit1)
	{
        $no1=mysqli_fetch_array($kayit1);    
        echo $no1["0"];
	}
	?>
